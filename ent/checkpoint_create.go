...
func (_c *CheckpointCreate) SetCheckpointID(v string) *CheckpointCreate {
	_c.mutation.SetCheckpointID(v)
	return _c
}

// SetPayload sets the "payload" field.
func (_c *CheckpointCreate) SetPayload(v []byte) *CheckpointCreate {
...
func (_c *CheckpointCreate) SetExpiresAt(v time.Time) *CheckpointCreate {
	_c.mutation.SetExpiresAt(v)
	return _c
}

// SetNillableExpiresAt sets the "expires_at" field if the given value is not nil.
func (_c *CheckpointCreate) SetNillableExpiresAt(v *time.Time) *CheckpointCreate {
	if v != nil {
		_c.SetExpiresAt(*v)
	}
	return _c
...
func (_c *CheckpointCreate) check() error {
	if _, ok := _c.mutation.CheckpointID(); !ok {
		return &ValidationError{Name: "checkpoint_id", err: errors.New(`ent: missing required field "Checkpoint.checkpoint_id"`)}
	}
	if _, ok := _c.mutation.Payload(); !ok {
		return &ValidationError{Name: "payload", err: errors.New(`ent: missing required field "Checkpoint.payload"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
