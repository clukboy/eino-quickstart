...
func (_q *KnowledgeBaseQuery) QueryFolders() *KnowledgeFolderQuery {
...
func (_q *KnowledgeBaseQuery) QueryDocuments() *DocumentQuery {
...
func (_q *KnowledgeBaseQuery) WithFolders(opts ...func(*KnowledgeFolderQuery)) *KnowledgeBaseQuery {
	query := (&KnowledgeFolderClient{config: _q.config}).Query()
...
func (_q *KnowledgeBaseQuery) WithDocuments(opts ...func(*DocumentQuery)) *KnowledgeBaseQuery {
	query := (&DocumentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *KnowledgeBaseQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*KnowledgeBase, error) {
	...
	if query := _q.withFolders; query != nil {
		if err := _q.loadFolders(ctx, query, nodes,
			func(n *KnowledgeBase) { n.Edges.Folders = []*KnowledgeFolder{} },
			func(n *KnowledgeBase, e *KnowledgeFolder) { n.Edges.Folders = append(n.Edges.Folders, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDocuments; query != nil {
		if err := _q.loadDocuments(ctx, query, nodes,
			func(n *KnowledgeBase) { n.Edges.Documents = []*Document{} },
			func(n *KnowledgeBase, e *Document) { n.Edges.Documents = append(n.Edges.Documents, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
