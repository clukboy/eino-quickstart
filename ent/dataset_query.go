...
type DatasetQuery struct {
	...
	withAgentDatasets *AgentDatasetQuery
...
func (_q *DatasetQuery) QueryFolders() *KnowledgeFolderQuery {
...
func (_q *DatasetQuery) QueryDocuments() *DocumentQuery {
...
// QueryAgentDatasets chains the current query on the "agent_datasets" edge.
func (_q *DatasetQuery) QueryAgentDatasets() *AgentDatasetQuery {
	query := (&AgentDatasetClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *DatasetQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *DatasetQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *DatasetQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *DatasetQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *DatasetQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *DatasetQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DatasetQuery) Clone() *DatasetQuery {
	...
	return &DatasetQuery{
		...
		withAgentDatasets: _q.withAgentDatasets.Clone(),
...
func (_q *DatasetQuery) WithFolders(opts ...func(*KnowledgeFolderQuery)) *DatasetQuery {
	query := (&KnowledgeFolderClient{config: _q.config}).Query()
...
func (_q *DatasetQuery) WithDocuments(opts ...func(*DocumentQuery)) *DatasetQuery {
	query := (&DocumentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithAgentDatasets tells the query-builder to eager-load the nodes that are connected to
// the "agent_datasets" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DatasetQuery) WithAgentDatasets(opts ...func(*AgentDatasetQuery)) *DatasetQuery {
	query := (&AgentDatasetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAgentDatasets = query
	return _q
}
...
func (_q *DatasetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Dataset, error) {
	...
	if query := _q.withFolders; query != nil {
		if err := _q.loadFolders(ctx, query, nodes,
			func(n *Dataset) { n.Edges.Folders = []*KnowledgeFolder{} },
			func(n *Dataset, e *KnowledgeFolder) { n.Edges.Folders = append(n.Edges.Folders, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDocuments; query != nil {
		if err := _q.loadDocuments(ctx, query, nodes,
			func(n *Dataset) { n.Edges.Documents = []*Document{} },
			func(n *Dataset, e *Document) { n.Edges.Documents = append(n.Edges.Documents, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAgentDatasets; query != nil {
		if err := _q.loadAgentDatasets(ctx, query, nodes,
			func(n *Dataset) { n.Edges.AgentDatasets = []*AgentDataset{} },
			func(n *Dataset, e *AgentDataset) { n.Edges.AgentDatasets = append(n.Edges.AgentDatasets, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DatasetQuery) loadFolders(ctx context.Context, query *KnowledgeFolderQuery, nodes []*Dataset, init func(*Dataset), assign func(*Dataset, *KnowledgeFolder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Dataset)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(knowledgefolder.FieldDatasetID)
	}
	query.Where(predicate.KnowledgeFolder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(dataset.FoldersColumn), fks...))
	}))
...
func (_q *DatasetQuery) loadDocuments(ctx context.Context, query *DocumentQuery, nodes []*Dataset, init func(*Dataset), assign func(*Dataset, *Document)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Dataset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *DatasetQuery) loadAgentDatasets(ctx context.Context, query *AgentDatasetQuery, nodes []*Dataset, init func(*Dataset), assign func(*Dataset, *AgentDataset)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Dataset)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(agentdataset.FieldDatasetID)
	}
	query.Where(predicate.AgentDataset(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(dataset.AgentDatasetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DatasetQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dataset.Table, dataset.Columns, sqlgraph.NewFieldSpec(dataset.FieldID, field.TypeUint64))
	_spec.From = _q.sql
