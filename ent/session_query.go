...
func (_q *SessionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *SessionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *SessionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *SessionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *SessionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *SessionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SessionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(session.Table, session.Columns, sqlgraph.NewFieldSpec(session.FieldID, field.TypeUint64))
	_spec.From = _q.sql
